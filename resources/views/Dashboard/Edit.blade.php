            ...
            <div class="container">
                ...
                <div class="form-gorup col-md-4 mt-3">
                    ...
                    <div class="mb-5" >
                        ...
                        <input type="text" class="form-control" id="title" name="title" value="{{$notices->title  }}" >
                    </div>
                    <div class="mb-5" >
                        <label for="description"><h4>Description</h4></label>
                        <textarea type="text" class="form-control" id="description" name="description">{{$notices->description}}</textarea>
                    </div>
